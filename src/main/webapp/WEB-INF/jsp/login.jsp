	...
	<body class="text-center">
		<main class="form-signin">
			<form class="form-signin" name='login' action="login" method='POST' novalidate="novalidate">
				...
				<div>
					<a href="${pageContext.request.contextPath }/utente/autoregistrazione">Registrati</a>
				</div>
			    ...
			    <form action="${pageContext.request.contextPath }/home">
			    	<button class="w-100 btn btn-lg btn-outline-primary" type="submit">Visualizza Annunci</button>
			    </form>
