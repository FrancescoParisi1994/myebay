			  ...
			  <div class="container">
			     ...
			     <div class="p-5 mb-4 bg-light rounded-3">
				      <div class="container-fluid py-5">
				        <h1 class="display-5 fw-bold">Benvenuto alla Raccolta Annunci</h1>
				        <p class="col-md-8 fs-4"></p>
				        <a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/annunci/public/search">Vai a Ricerca</a>
				      </div>
			    </div>
			   ...
			   <div class="container px-4 py-5" id="featured-3">
			    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
			      ...
			      <div class="feature col">
			        ...
			        <a href="${pageContext.request.contextPath}/annunci/gestione" class="icon-link">
			          Vai alla funzionalità
			          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
			        </a>
			      </div>
