...
public interface UtenteRepository extends CrudRepository<Utente, Long>, JpaSpecificationExecutor<Utente> {
	...
	List<Utente> findAllByUsernameIgnoreCaseContainingOrNomeIgnoreCaseContainingOrCognomeIgnoreCaseContainingOrderByNomeAsc(
			String cognome, String nome, String username);
}
